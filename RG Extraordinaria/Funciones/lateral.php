 ...
 <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/team/<?php echo $_SESSION['Imagen'] ; ?>" alt="Sue Palacios">
        <div>
          <p class="app-sidebar__user-name"><?php echo $_SESSION['Nombre'].' '.$_SESSION['Apellido'] ;?></p>
          <p class="app-sideba__user-designation"><?php echo $_SESSION['Nombre_Rol'] ; ?></p>
        </div>
      </div>
      <ul class="app-menu">
